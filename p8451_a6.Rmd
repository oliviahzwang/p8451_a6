...
```{r}
nhanes_tidy$race = nhanes$race1
nhanes_tidy$education = nhanes$education
nhanes_tidy$hh_income = nhanes$hh_income
nhanes_tidy$diabetes = nhanes$diabetes
nhanes_tidy$phys_active = nhanes$phys_active
nhanes_tidy$smoke = nhanes$smoke100

train_index = createDataPartition(nhanes_tidy$diabetes, p = 0.7, list = FALSE)

nhanes_train <- nhanes_tidy[train_index,]
nhanes_test <- nhanes_tidy[-train_index,]
```
